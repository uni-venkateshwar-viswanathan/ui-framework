...
export const uniphoreCheckboxStyles = css`
    ...
    .uniphore-checkbox-label > input[disabled] + .uniphore-checkbox-label-cb, .uniphore-checkbox-label > input[disabled] ~ .uniphore-checkbox-label-text {
        cursor: default;
        opacity: 0.5;
    }
                    
    .uniphore-checkbox-label > input:checked + .uniphore-checkbox-label-cb uniphore-icon  {
        display: flex;
    }
`;