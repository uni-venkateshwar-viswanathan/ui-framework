...
export const uniphoreIconMoonStyle = css`
  @font-face {
    font-family: 'icomoon';
    src: url('fonts/icomoon.eot?624fxz');
    src: url('fonts/icomoon.eot?624fxz#iefix') format('embedded-opentype'),
      url('fonts/icomoon.ttf?624fxz') format('truetype'),
      url('fonts/icomoon.woff?624fxz') format('woff'),
      url('fonts/icomoon.svg?624fxz#icomoon') format('svg');
    font-weight: normal;
    font-style: normal;
    font-display: block;
  }
  ...
  .icon-drop-down-arrow-collapse:before {
    content: '\\e92b';
  }
  .icon-edit:before {
    content: '\\e92c';
  ...
  .icon-inside-organization:before {
    content: '\\e93b';
  }
  .icon-intent:before {
    content: '\\e93c';
  ...
  .icon-outside-organization:before {
    content: '\\e94a';
  }
  ...
  .icon-sentiment-extremely-dissatisfied:before {
    content: '\\e959';
  }
  ...
  .icon-shared-slide-solid:before {
    content: '\\e960';
  }
  .icon-star:before {
    content: '\\e961';
